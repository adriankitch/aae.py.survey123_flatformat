class resultObject:
    ...
    def collate(self, globalHeader):
        ...
        species = self.collation[globalHeader.index('species_obs')] if self.collation[globalHeader.index(
            'species_samp')] is None else self.collation[globalHeader.index('species_samp')]
